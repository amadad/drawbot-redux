...
# Helper function to draw gradient background manually
def draw_gradient_bg(color1, color2):
    """Draw a gradient background using rectangles"""
    steps = 50
    for i in range(steps):
        ...
        db.fill(r, g, b)
        db.rect(0, i * page_height/steps, page_width, page_height/steps + 1)
...
# Gradient background
draw_gradient_bg(color_schemes[0]['primary'], color_schemes[0]['secondary'])
...
# Different gradient
draw_gradient_bg(color_schemes[0]['secondary'], color_schemes[0]['accent'])
...
# Gradient transition
draw_gradient_bg(color_schemes[1]['primary'], color_schemes[1]['secondary'])
...
# Motion gradient
draw_gradient_bg(color_schemes[1]['secondary'], color_schemes[1]['accent'])
...
db.font("Helvetica-Bold")
db.fontSize(16)
db.text("LEGAL ALERT", (margin + 20, 150))
db.font("Helvetica")
db.fontSize(12)
db.fill(0, 0, 0, 0.8)
...
draw_gradient_bg(color_schemes[2]['primary'], color_schemes[2]['secondary'])
...
draw_gradient_bg(color_schemes[2]['secondary'], color_schemes[2]['accent'])
...
# Temporal gradient
draw_gradient_bg(color_schemes[3]['primary'], color_schemes[3]['secondary'])
...
draw_gradient_bg(color_schemes[3]['secondary'], color_schemes[3]['accent'])
